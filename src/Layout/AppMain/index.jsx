...
const FoundationHome = lazy(() => import("../../Foundation/pages/Home"));
const FoundationAbout = lazy(() => import("../../Foundation/pages/About"));
const FoundationProjects = lazy(() => import("../../Foundation/pages/Projects"));
const FoundationContact = lazy(() => import("../../Foundation/pages/Contact"));
    ...
    return (
        <Fragment>
            <Routes>
                ...
                {/* Fundacja Nowyja */}
                <Route path="/" element={
                    <Suspense fallback={<div className="loader-container"><div className="loader-container-inner"><div className="text-center"><Loader type="ball-pulse-rise"/></div></div></div>}>
                        <FoundationHome />
                    </Suspense>
                } />
